  ...
  <div class="set">
    <div>
      ...
      >
        ...
        >
          <el-input v-model="baseForm.title" :maxlength="40" style="width: 300px" />
        </el-form-item>
        <el-form-item
          label="副标题："
          prop="sub_title"
          :rules="[{ required: true, message: '请输入站点副标题', trigger: 'blur' }]"
        >
          <el-input v-model="baseForm.sub_title" :maxlength="40" style="width: 300px" />
        </el-form-item>
        <el-form-item label="关键词：" prop="keyword">
          <el-input v-model="baseForm.keyword" :maxlength="40" />
        </el-form-item>
        <el-form-item
          label="站点地址："
          prop="url"
          :rules="[{ required: true, message: '请输入站点地址', trigger: 'blur' }]"
        >
          <el-input v-model="baseForm.url" :maxlength="20" />
        </el-form-item>
        <el-form-item
          label="站点描述："
          prop="descript"
          :rules="[{ required: true, message: '请输入站点描述', trigger: 'blur' }]"
        >
          <el-input
        ...
        >
          <el-input v-model="baseForm.email"  :maxlength="20" />
        </el-form-item>
        <el-form-item label="ICP备案号：" prop="icp">
          <el-input v-model="baseForm.icp" :maxlength="50" />
        </el-form-item>
        <el-form-item style="margin-bottom: 0">
          <el-button @click="submitForm('form')" :disabled="postOption">
            {{ postOption ? '保存中' : '保存'}}
          </el-button>
        </el-form-item>
      </el-form>
      ...
      <div class="right-form head">
        ...
        >
          ...
          <el-form-item label="姓名">
            <el-input v-model="userForm.name" :maxlength="20" />
          </el-form-item>
          <el-form-item label="个性签名">
            <el-input v-model="userForm.slogan" :maxlength="20" />
          </el-form-item>
          <el-form-item
            label="原密码"
            prop="oldPassword"
          ...
          <el-form-item style="margin-bottom: 0;">
            <el-button  @click="submit('userForm')" :disabled="postUser">
              {{ postUser ? '更改中' : '更改' }}
            </el-button>
          </el-form-item>
        </el-form>
