  ...
  <div class="release" v-loading="fetch">
    ...
    >
      <el-col :span="16">
        ...
        >
          <el-input v-model="form.title" :maxlength="40" style="width: 300px" />
        </el-form-item>
        <el-form-item
          label="文章关键字"
          prop="keyword"
          :rules="[{ required: true, message: '请输入文章关键字', trigger: 'blur' }]"
        >
          <el-input v-model="form.keyword" :maxlength="20" style="width: 300px" />
        </el-form-item>
        <el-form-item
          label="文章标签"
          prop="tag"
          :rules="[{ required: true, type: 'array', message: '请选择文章标签', trigger: '' }]"
        >
        ...
        <el-form-item
          label="文章内容"
          prop="content"
          :rules="[{ required: true, message: '请输入文章内容', trigger: 'blur, change' }]"
          class="markdown"
        >
          <markdown-editor
        ...
        <el-form-item style="margin-bottom: 0">
          <el-button :disabled="posting" @click="submitForm('form')">
